...
const VALID_PATHS = new Set(["/", "/about", "/assets/appeal-flow.svg", "/assets/favicon.svg", "/assets/style.css", "/best-pet-insurance", "/contact", "/fetch-pet-insurance", "/how-to-submit-a-pet-insurance-claim", "/lemonade-pet-insurance", "/lemonade-vs-spot", "/pet-insurance-claim-denied", "/pet-insurance-cost", "/pet-insurance-promo-code", "/privacy", "/robots.txt", "/sitemap.xml", "/spot-pet-insurance"]);
